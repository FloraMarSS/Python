...
def compilatore(nome):#inserire il nome della persona a cui fare CF
	...
	if (dati_persona[1].isspace()) == False:
...
compilatore('floramarida')
#compilatore('nome') # decommentare e sostituire 'nome' con nome della persona di cui si vuole il CF (NB:in minuscolo)
